...
import { useAppUpdate, openExternalUrl, getAppInfoSync } from "../app-update";
      ...
      <SidebarHeader className={cn("gap-2 px-3 pt-3 pb-2", headerClassName)} style={headerStyle}>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" sideOffset={6} className="w-56">
            <DropdownMenuItem
              disabled={!liveTranslationAvailable}
...
function UserProfileDropdown({ onOpenSettings }: { onOpenSettings: () => void }) {
  ...
  return (
    <DropdownMenu>
      ...
      />
      <DropdownMenuContent align="start" side="top" sideOffset={4} className="w-72 overflow-hidden p-0">
